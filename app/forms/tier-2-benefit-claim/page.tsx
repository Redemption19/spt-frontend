                ...
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-10">
                  ...
                  <div className="space-y-6">
                    <div className="relative flex flex-col sm:flex-row items-center gap-4 w-full max-w-full overflow-hidden px-4">
                      ...
                      <Separator className="hidden sm:block flex-1 max-w-full" />                    </div>                    <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
                      <FormField
                        control={form.control}
                        name="nameOnAccount"
                        render={({ field }) => (
                    ...
                    <div className="space-y-6 border rounded-md p-6 bg-muted/20">
                      ...
                      <div className="space-y-6 mt-6">
                        <div className="relative flex flex-col sm:flex-row items-center gap-4 w-full max-w-full overflow-hidden">
                          ...
                          <Separator className="hidden sm:block flex-1 max-w-full" />                        </div>                        <div className="p-6 border rounded-md bg-muted/20">
                          <FormField
                            control={form.control}
